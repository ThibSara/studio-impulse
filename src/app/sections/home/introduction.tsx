...
export function Introduction() {
  ...
  return (
    <section
      ...
      className="relative isolate overflow-hidden bg-[#07183B] rounded-3xl  px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0"
    >
          ...
          <div className="lg:pr-4">
            <div className="max-w-xl text-base leading-7 text-white lg:max-w-lg">
              ...
              <p className="mt-8">
                ...
                web. De la conception initiale au développement final, nous vous
